...
const SECTIONS_CONFIG = [
  ...
  },
  {
    ...
    label:       'Content',
    icon:        '📝',
    placeholder: 'Your main message — use the | character to split slides manually! e.g. First slide | Second slide',
    rows:        4,
    ...
    hint:        'Long text splits automatically. Tip: Type | to force a new text slide!',
  },
  {
    key:         'conclusion',
    label:       'Conclusion',
